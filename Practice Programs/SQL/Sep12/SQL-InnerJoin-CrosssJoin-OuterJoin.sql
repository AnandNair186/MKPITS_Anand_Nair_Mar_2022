...
cross
join fees
where student2.admission_no=fees.admission_no
...
on student2.admission_no=fees.admission_no;
...
from student2
right outer join fees on
student2.admission_no=fees.admission_no;
        
------Full Outer join-----------

select student2.admission_no,
student2.Fname,
student2.Lname,
fees.course,
fees.amount_paid
from student2 
full outer join fees on student2.admission_no=fees.admission_no
